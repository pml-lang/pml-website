...
-]
    ...
    [ch (id=options) [title Options]
        ...
        To see the list of options available when a PML document is converted to HTML, please refer to section "Input Parameters" in chapter [link (url=[u:get pml_website]/docs/commands_manual/index.html#command_PML_to_HTML) Convert PML to HTML] of the [link (url=[u:get pml_website]/docs/commands_manual/index.html ) PMLC Commands Reference Manual].
        ...
        [list (html_style="list-style-type:decimal")
            ...
            [el
                ...
                The [c options] node must be defined before the [c doc] node.
...
-]
        [note
            Option [c input] is only supported as a command line argument.
            This option cannot be used in a PML document or in a shared options file.
        ]
    ]

    [ch (id=HTML_attributes_2) [title HTML Attributes]

        If you want to change the style of a [i single] node, you can define an [i HTML attribute] for that node, as explained [xref (ref_id=HTML_attributes) previously].
        You can assign any valid [link (url=https://www.w3schools.com/css/) CSS] to the node's [c html_style] attribute, or you can use an [c html_class] attribute.
        ...
        Please refer to chapter [xref (ref_id=HTML_attributes)] for more information.
    ]
    ...
    [ch (id=customized_css) [title Customized CSS]
        ...
        For more information, please refer to parameter [c CSS_files] in section "Input Parameters" of chapter [link (url=[u:get pml_website]/docs/commands_manual/index.html#command_PML_to_HTML ) Convert PML to HTML].
        ...
        If you want to change the style just for an [i individual] node, you can use the [c html_style] attribute, as [xref (ref_id=HTML_attributes) seen already]. Alternatively, you can define an [i identifier] for the node, and then use the identifier in the CSS file to change the style.
    ...
    [ch (id=user_defined_nodes) [title User-Defined Nodes]
        ...
        Please refer to chapter [link (url=[u:get pml_website]/docs/advanced_features/index.html#user_defined_nodes ) User-Defined Nodes] for more information.
    ]
]
