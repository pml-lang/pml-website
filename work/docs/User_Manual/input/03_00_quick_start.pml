[ch (id=quick_start) [title Quick Start]
    ...
    After [link (url=[u:get pml_website]/downloads/install.html ) installing] PML, you can create a web document in three easy steps:
...
-]
            ...
            [note
                For instructions on how to do this in Windows, search for "open a terminal in Windows", or refer to [link (url=https://www.howtogeek.com/235101/10-ways-to-open-the-command-prompt-in-windows-10/) this] article.
            ]
...
-]
    ...
    [admon [alabel Tips]
        To see the list of options you can use with command [c PML_to_HTML], refer to chapter [link (url=[u:get pml_website]/docs/commands_manual/index.html#command_PML_to_HTML) Convert PML to HTML] in [link (url=[u:get pml_website]/docs/commands_manual/index.html) PMLC Commands Reference Manual]. This manual also lists all other commands you can use with [c pmlc].
