[ch (id=text_processing) [title Text Processing]
    ...
    A PML document is written using the [link (url=https://pdml-lang.dev/) PDML] syntax.
    Therefore, all features available in PDML are also supported in PML.
    You can refer to PDML's [link (url=https://pdml-lang.dev/docs/index.html) documentation] to get more information about PDML.
